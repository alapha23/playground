...
parser.add_argument('--image_dir', default="/home/joe/cat_dog/dataset")
...
parser.add_argument('--frac', default = 0.99, type = float)
parser.add_argument('--allow_growth', default = True, type = bool)
...
def create_model(FLAGS):
    ...
    #input1 = tf.keras.layers.Input(dtype=tf.float32, shape = (im_w, im_h, im_c), name = 'input1')
    #input1 = tf.keras.layers.Input(dtype=tf.float32, shape = (im_w, im_h, im_c), name = 'input1')

    y_true1 = tf.placeholder(dtype=tf.float32, shape = (None, FLAGS.n_classes), name='y_true1')
    is_training = tf.placeholder(dtype=tf.bool, shape=[], name = 'is_training')
    lr = tf.placeholder(tf.float32, shape = [], name = 'lr_holder')
